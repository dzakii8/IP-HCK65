...
//     for (const pass of user.SavedPasswords) {
//       if (new Date(pass.updatedAt) > new Date(new Date() + 1000)) {

//         async function main() {
//           const info = await transporter.sendMail({
//             from: 'Password Manager', // sender address
//             to: user.email, // list of receivers
//             subject: "Reminder to Change Password", // Subject line
//             text: "Some passwords are not changed for more than 1 minute", // plain text body
//             html: `<p></p>`
//           });
